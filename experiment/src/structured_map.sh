...
#python experiment_structured_map.py --config_dir=cfgs/canceronline_map 
python experiment_structured_map.py --config_dir=cfgs/fcmnist_map
python experiment_structured_map.py --config_dir=cfgs/LeNetfashionmnist_map
python experiment_structured_map.py --config_dir=cfgs/LeNetfmnist_map
python experiment_structured_map.py --config_dir=cfgs/LeNetcifar10_map
