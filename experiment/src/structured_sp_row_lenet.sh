...
python experiment_structured_row.py --config_dir=cfgs/LeNetfashionmnist_newpriors/ --repeat=2
python experiment_structured_row.py --config_dir=cfgs/LeNetcifar10_newpriors/ --repeat=2