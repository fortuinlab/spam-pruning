                ...
                if sparse_method is not None:
                    ...
                    if self.use_map or self.config['laplace']['n_epochs_burnin']> epoch :
                        ...
                        if self.resnet_inplanes == 64 and self.config['model_name'] == 'ResNet':
                            return f'{model_name}_64_aug_{laplace_type}_{prior}_{epoch}_wp'
                        else:
                            return f'{model_name}_{self.config["dataset_name"]}_aug_tempfixed_{laplace_type}_{prior}_{epoch}_wp'
